Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "rails_carmencita_production"
  ...
  if ENV["ENABLE_ELASTICSEARCH_LOGGING"].present?
    config.logger = ActiveSupport::TaggedLogging.new(ElasticsearchLogger.new)
